...
$(`#form1`).on("submit", function () {
  ...
  let validadorNegativo = Math.sign(horasVuelo);
  if (validadorNegativo === 1) {
    ...
    alert("Digita solo numeros positivos y mayores que 0");
  }
});
...
function comprarFotos() {
  ...
  let validadorNegativo = Math.sign(cantidad);
  if (validadorNegativo === 1) {
